...
def check_phase_times(log_directory, view_settings):
    ...
    for file_path, contents in files.items():
        ...
        print(f"File: {file_path}, Total: {phase_times[6]}, Phases : {phase_times[1]} / {phase_times[2]} / {phase_times[3]} / {phase_times[4]} / {phase_times[5] if phase_times[5] else 0}")
